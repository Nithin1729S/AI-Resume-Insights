      ...
      <div className="flex h-full flex-col justify-start overflow-y-auto p-4 [-ms-overflow-style:none] [scrollbar-width:none] hover:[-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <div className="rounded-xl border border-gray-100 bg-white p-8 shadow-sm">
          <div className="mb-6 flex items-center justify-between">
            ...
            <div
              className={`rounded-full px-4 py-2 ${brevity_score >= 10 ? "bg-green-100 text-green-700" : ""} ${brevity_score >= 7 && brevity_score < 10 ? "bg-green-50 text-green-600" : ""} ${brevity_score >= 5 && brevity_score < 7 ? "bg-orange-50 text-orange-600" : ""} ${brevity_score < 5 ? "bg-red-50 text-red-600" : ""} `}
            >
              <span className="font-semibold">{brevity_score}</span>
